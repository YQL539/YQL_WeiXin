...
#define ALDColor(r, g, b) [UIColor colorWithRed:(r/255.0) green:(g/255.0) blue:(b/255.0) alpha:1.0]
// 背景色
#define GlobelBgColor ALDColor(237, 240, 242)
// 分割线颜色
#define GlobelSeparatorColor ALDColor(226, 226, 226)
// 普通状态下的图片
#define normalImage [self createImageWithColor:ALDColor(255, 255, 255)]
// 高亮状态下的图片
#define highImage [self createImageWithColor:ALDColor(242, 242, 242)]
...
@interface ALDActionSheet ()
{
    int _tag;
}

@property (nonatomic, weak) ALDActionSheet *actionSheet;
@property (nonatomic, weak) UIView *sheetView;

@end

@implementation ALDActionSheet

- (instancetype)initWithDelegate:(id<ALDActionSheetDelegate>)delegate CancelTitle:(NSString *)cancelTitle OtherTitles:(NSString *)otherTitles, ...
{
    ALDActionSheet *actionSheet = [self init];
